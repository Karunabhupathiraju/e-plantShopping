...
const plantsArray = [
  ...
  },
  {
    ...
    plants: [
      ...
      { name: "Cast Iron Plant", image: "https://cdn.pixabay.com/photo/2017/02/16/18/14/plant-2077665_1280.jpg", description: "Very tolerant of poor light and irregular watering.", cost: "$22" },
      { name: "Spider Plant", image: "https://cdn.pixabay.com/photo/2018/07/11/06/47/chlorophytum-3530413_1280.jpg", description: "Low maintenance and can adapt to various environments.", cost: "$12" },
      { name: "Parlor Palm", image: "https://cdn.pixabay.com/photo/2016/11/17/20/18/parlor-palm-1837020_1280.jpg", description: "Ideal for low light conditions and minimal care.", cost: "$18" }
    ]
  }
];
...
const ProductList = () => {
  ...
  const handleAddToCart = (product) => {
    // Dispatch action to add item to cart (assuming you have setup Redux or other state management)
  ...
  const handleCartClick = (e) => {
    e.preventDefault();
    setShowCart(true);
    setShowPlants(false); // Hide plants when cart is clicked
  };

  const handlePlantsClick = (e) => {
    e.preventDefault();
    setShowPlants(true);
    setShowCart(false); // Hide cart when plants are clicked
  };
          ...
          {plantsArray.map(category => (
            <div key={category.category}>
              ...
              <div className="products">
                {category.plants.map((product, index) => (
